...
void intern_string_list_pop(string_list_t *this, ssize_t index)
{
    ...
    destroy_node(container_remove_node(list, index), NULL, LIST_TRUE);
}
...
void intern_string_list_pop_front(string_list_t *this)
{
    ...
    destroy_node(container_remove_first_node(list), NULL, LIST_TRUE);
}
...
void intern_string_list_pop_back(string_list_t *this)
{
    ...
    destroy_node(container_remove_last_node(list), NULL, LIST_TRUE);
}